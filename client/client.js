...
socket.on('connect', function(){
  ...
  socket.emit('signin_request', {'token': '997124c133064411b616107a48a14f2e'});
  setTimeout(function() {
  ...
  setTimeout(function() {
    socket.emit('topic_11', { id: 1, topic_id: 11, sender: 1, reply_to: null, body: 'privet', attrs: null, sent_at: new Date().getTime() });
  }, 3000);
});
