var insertMessageQuery = 'INSERT INTO messages (stamp_id, topic_id, sender, reply_to, body, attrs) VALUES($1, $2, $3, $4, $5, $6) RETURNING id, (SELECT username FROM users WHERE id=$3) as sender, topic_id, reply_to, body, attrs, extract(epoch from sent_at)::int as sent_at';
